...
function fillDomClusterTopicResult(jsonTopicEntry, domTitle, domExcerpt, domLink) {
    ...
    domLink.setAttribute('href', `./map.html?id=${jsonTopicEntry.mapId}&topic=${jsonTopicEntry.contentId}`); //add a link to the map.html page (=reader custom) for the next part
}
...
function fillDomClusterMapResult(jsonMapEntry, domTitle, domExcerpt, domLink) {
    ...
    domLink.setAttribute('href', `./map.html?id=${jsonMapEntry.mapId}`);
}
...
function fillDomClusterDocumentResult(jsonDocumentEntry, domTitle, domExcerpt, domLink) {
    ...
    domLink.setAttribute('href', jsonDocumentEntry.contentUrl);
}
